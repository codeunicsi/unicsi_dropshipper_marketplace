      ...
      if (data.data.role === "ADMIN") {
        window.location.href =
          process.env.NEXT_ENV === "PRODUCTION"
            ? "https://admin.unicsi.com/admin/dashboard"
            : "/admin/dashboard";
      } else if (data.data.role === "RESELLER") {
        window.location.href =
          process.env.NEXT_ENV === "PRODUCTION"
            ? "https://app.unicsi.com/marketplace"
            : "/marketplace";
      } else if (data.data.role === "KEY_ACCOUNT_MANAGER") {
        window.location.href =
          process.env.NEXT_ENV === "PRODUCTION"
            ? "https://kam.unicsi.com/kam/dashboard"
            : "/kam/dashboard";
      } else {
        window.location.href =
          process.env.NEXT_ENV === "PRODUCTION" ? "https://unicsi.com" : "/";
      }
    } catch (err: any) {
